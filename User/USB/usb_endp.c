...
* Return         : None.
*******************************************************************************/
/*  Co bao goi IN truoc da duoc may tinh lay xong.
 *  Diem cuoi IN chi co MOT bo dem: neu gui goi tiep khi may tinh chua lay
 *  goi truoc thi goi truoc bi ghi de va mat. Phan chan doan trong tps_diag.c
 *  cho co nay truoc moi lan gui. Khoi tao bang 1 vi luc dau bo dem dang ranh. */
volatile uint8_t USB_TxDone = 1;
